...
date: "Compiled on 20 April 2023"
output:
    html_document:
        toc: true
        toc_depth: 2
...
used to generate the results files read in this notebook are available [here](this is the link). If you are
unable to reproduce any result, please let me know at `george.hall@ucl.ac.uk`.
...
<details>
<summary>Function to read results file</summary>
...
<details>
<summary>Function to parse results dataframe</summary>
...
parse_results <- function(results) {
    ...
    results$upreg_lfc <- as.factor(round(lfcs, 2))
...
<details>
<summary>Function to plot accuracy results</summary>
...
plot_accuracy_results <- function(results) {
    ...
    p <- ggplot(results, aes(x = upreg_lfc, y = value)) +
        ...
        xlab("Upregulated log-fold change") + ylim(0, 1) +
...
<details>
<summary>Function to read results file with statistics</summary>
...
<details>
<summary>Function to save ggplots</summary>
...
```r
# Generate beeswarm plots following Milo paper
...
plot_pc1_estimates <- function(results, other_method, other_mses) {
    ...
    p <- ggplot(results, aes(x = truth, y = .data[[other_method]])) +
            ...
            facet_grid(upreg_pc1 ~ cell_type)
